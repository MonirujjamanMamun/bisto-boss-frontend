...
const TableRow = ({ i, item }) => {
  const { name, image, price } = item.menuItemId;
  ...
  return (
    <tr className="hover:bg-[#bfac8fad] border-b transition duration-300">
      ...
      <td className="py-4 px-6 border-b text-end">
        <button className="w-[50px] h-[50px] bg-red-500 hover:scale-110 scale-100 transition-all duration-100 text-white py-2 px-3 rounded-md">
